...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-ScooterShooter_MiSTer.git"
CORE_NAME=(Arcade-ScooterShooter)
...
UPSTREAM_CORE_NAME=(Arcade-ScooterShooter)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-ScooterShooter.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-ScooterShooter.rbf)
